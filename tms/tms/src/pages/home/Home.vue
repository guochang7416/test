...
const tu2 = ref()
onMounted(()=>{
    tu1.value.style.width = '100%'
    tu1.value.style.height = '320px'
    const myChart1 = echarts.init(tu1.value);
    myChart1.setOption( {
        title: {
            text: ''
        },
    ...
    tu2.value.style.width = '100%'
    tu2.value.style.height = '340px'
    const myChart2 = echarts.init(tu2.value);
    myChart2.setOption( {
        title: {
            text: ''
        },
    ...
    <div class="main">
        <div class="left">
            <div class="top content">
                ...
                <div class="data">
                    <div class="zhanghu-item" v-for="item in zhanghu" :key="item.number">
