        ...
        <div class="top">
            ...
            <div class="content">
                <div class="select">
                    ...
                    <el-button icon="el-icon-search" style="margin-left: 20px;">查询</el-button>
        ...
        <div class="bottom">
            ...
            <div class="content">
                <div class="select">
                    ...
                    <div class="right">
                        <span>资金账户：</span>
                        <el-select v-model="value" class="m-2" placeholder="全选" size="small">
                            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value" />
                        </el-select>
                        <span>交易所：</span>
                        <el-select v-model="value" class="m-2" placeholder="全选" size="small">
...
/deep/ .el-table__body-wrapper::-webkit-scrollbar {
    ...
    /deep/ .el-table::after,/deep/ .el-table::before {
        height: 0;
    }
</style>